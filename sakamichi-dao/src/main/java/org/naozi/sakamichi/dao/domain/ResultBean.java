...
public class ResultBean {
	...
	public static ResultBean success(String msg, Object result) {
		return new ResultBean(ResultBean.STATUS_OK, msg, result);
	}

	public static ResultBean success(String msg, String data) {
		return new ResultBean(ResultBean.STATUS_OK, msg, data);
	}

	public static ResultBean success(String msg, String data, Object result) {
	...
	public static ResultBean error(String msg) {
		return new ResultBean(ResultBean.STATUS_ERROR, msg);
	}
}