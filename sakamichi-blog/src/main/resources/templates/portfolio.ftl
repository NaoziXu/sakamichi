    ...
    <div class="container-portfolio">
        ...
        <ul id="filters" class="clearfix">
            <li><span class="filter active"
                      data-filter="catWeb catGraphic catMotion logo">All</span></li>
            <li><span class="filter" data-filter="catWeb">Web Design</span></li>
            <li><span class="filter" data-filter="catGraphic">Graphic Design</span>
            </li>
            <li><span class="filter" data-filter="catMotion">Motion Graphic</span>
            </li>
        ...
        <div id="portfoliolist">
            ...
            <div class="view view-first portfolio catWeb" data-cat="catWeb">
                ...
                <div class="mask">
                    ...
                    <a href="http://www.youtube.com/watch?v=c9MnSeYYtYY"
                       rel="portfolio" class="info external"><i
            ...
            <div class="view view-first portfolio catWeb" data-cat="catWeb">
                ...
                <div class="mask">
                    ...
                    <a href="http://themeforest.net/item/flexyvcard-responsive-vcard-template-/7158750?WT.ac=solid_search_thumb&amp;WT.seg_1=solid_search_thumb&amp;WT.z_author=flexycodes?width=800&amp;height=500&amp;iframe=true"
                       rel="portfolio" class="info external">
            ...
            <div class="view view-first portfolio catMotion" data-cat="catMotion">
                ...
                <div class="mask">
                    ...
                    <a href="http://themeforest.net/?width=800&amp;height=500&amp;iframe=true"
                       rel="portfolio" class="info external"><i
            ...
            <div class="view view-first portfolio catWeb" data-cat="catWeb">
                ...
                <div class="mask">
                    ...
                    <a href="http://vimeo.com/7449107" rel="portfolio"
                       class="info external"><i class="fa fa-play"></i></a>
                </div>
            </div>
            ...
            <div class="view view-first portfolio catMotion" data-cat="catMotion">
                ...
                <div class="mask">
                    ...
                    <a href="http://themeforest.net/user/flexycodes" target="_blank"
                       class="info external"><i class="fa fa-link"></i></a>
                </div>
            </div>
            ...
            <div class="view view-first portfolio logo" data-cat="logo">
                ...
                <div class="mask">
                    ...
                    <a href="http://themeforest.net/user/flexycodes"
                       class="info external"><i class="fa fa-link"></i></a>
                </div>
            </div>
            ...
            <div class="view view-first portfolio logo" data-cat="logo">
                ...
                <div class="mask">
                    ...
                    <a href="http://themeforest.net/user/flexycodes/portfolio"
                       target="_blank" class="info external"><i
                            class="fa fa-link"></i></a>
                </div>
            </div>
