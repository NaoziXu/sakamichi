...
<div class="header">
    ...
    <div class="nav">
        <a href="/getContent/index" class="active">文章</a>
        <a href="/getContent/whisper">微语</a>
        <a href="/getContent/leacots">留言</a>
        <a href="/getContent/album">相册</a>
        <a href="/getContent/about">关于</a>
    </div>
    <ul class="layui-nav header-down-nav">
        <li class="layui-nav-item"><a href="/getContent/index" class="active">文章</a></li>
        <li class="layui-nav-item"><a href="/getContent/whisper">微语</a></li>
        <li class="layui-nav-item"><a href="/getContent/leacots">留言</a></li>
        <li class="layui-nav-item"><a href="/getContent/album">相册</a></li>
        <li class="layui-nav-item"><a href="/getContent/about">关于</a></li>
    </ul>
                    ...
                    <div class="layui-row">
                        ...
                        <div class="layui-col-xs12 layui-col-sm8 layui-col-md7">
                            <div class="item-cont">
                                ...
                                <a href="/getContent/details" class="go-icon"></a>
                            </div>
                        </div>
                    </div>
                </div>
